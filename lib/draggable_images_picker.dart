...
///  more info: https://github.com/idekorslet/draggable-images-picker
...
class DraggableImagesPicker {
  ...
  DraggableImagesPicker({this.maxImageCount=Constant.maxAllowedImage, required this.localContext, this.imageStringList});
  ...
  void init(Function setState) {
    debugPrint('[draggable_images_picker] init process');
    ...
    _setState = setState;
    debugPrint('[draggable_images_picker] init process done');
  }
  ...
  void onWidgetRebuild() {
    debugPrint('[draggable_images_picker @onWidgetRebuild]image container list length: ${imageContainerList.length}');
    _reOrderImageList();
    ...
    wrappedImages = ReorderableWrap(
        ...
        // children: imagesContainer ?? imageContainerList
  ...
  Future<void> showAlert() async {
    if (localContext.mounted) {
      CustomPopup.showDefaultPopup(title: 'Warning', content: "Only $maxImageCount image allowed", context: localContext);
    }
  }
}